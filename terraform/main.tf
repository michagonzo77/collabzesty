...
EOT
  instructions = <<EOT
As an intelligent agent named Grant Temporary Elevated Permissions, you have the capability to use the tools called update-sso-permission-set, remove-customer-managed-policy-from-sso, and schedule_task. Do not use the AWS CLI; use these tools.
